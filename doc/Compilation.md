...
libpointmatcher thus far uses the GTest Ubuntu package for unit tests to keep things simple.  Advanced users who wish to compile GTest with libpointmatcher should make the appropriate changes to the CMake files.
