...
namespace pointmatcher
{
	void pybindDataPoints(py::class_<PM>& p_class)
	{
		...
		py::class_<Label>(pyDataPoints, "Label")
			.def_readwrite("text", &Label::text, "name of the label")
		...
		pyDataPoints
			...
			.def(py::init<const Labels&, const Labels&, const size_t>(),
			py::arg("featureLabels"), py::arg("descriptorLabels"), py::arg("pointCount"))

			.def(py::init<const Labels&, const Labels&, const Labels&, const size_t>(),
			py::arg("featureLabels"), py::arg("descriptorLabels"), py::arg("timeLabels"), py::arg("pointCount"))
			...
			.def(py::init<const Matrix&, const Labels&, const Matrix&, const Labels&>(),
				py::arg("features"), py::arg("featureLabels"), py::arg("descriptors"), py::arg("descriptorLabels"))

			.def(py::init<const Matrix&, const Labels&, const Matrix&, const Labels&, const PM::Int64Matrix&, const Labels&>(),
				py::arg("features"), py::arg("featureLabels"), py::arg("descriptors"), py::arg("descriptorLabels"), py::arg("times"),py::arg("timeLabels"))

			.def("__eq__", &DataPoints::operator==, py::arg("that"))

			.def("getNbPoints", &DataPoints::getNbPoints)
			.def("getEuclideanDim", &DataPoints::getEuclideanDim)
			.def("getHomogeneousDim", &DataPoints::getHomogeneousDim)
			.def("getNbGroupedDescriptors", &DataPoints::getNbGroupedDescriptors)
			.def("getDescriptorDim", &DataPoints::getDescriptorDim)
			.def("getTimeDim", &DataPoints::getTimeDim)
			...
			.def("getFeatureViewByName", (ConstView (DataPoints::*)(const std::string &) const) &DataPoints::getFeatureViewByName, py::arg("name"))
			.def("getFeatureViewByName", (View (DataPoints::*)(const std::string &)) &DataPoints::getFeatureViewByName, py::arg("name"))
			.def("getFeatureRowViewByName", (ConstView (DataPoints::*)(const std::string&, const unsigned) const) &DataPoints::getFeatureRowViewByName, py::arg("name"), py::arg("row"))
			...
			.def("getDescriptorViewByName", (ConstView (DataPoints::*)(const std::string&) const) &DataPoints::getDescriptorViewByName, py::arg("name"))
			.def("getDescriptorViewByName", (View (DataPoints::*)(const std::string&)) &DataPoints::getDescriptorViewByName, py::arg("name"))
			.def("getDescriptorRowViewByName", (ConstView (DataPoints::*)(const std::string&, const unsigned) const) &DataPoints::getDescriptorRowViewByName, py::arg("name"), py::arg("row"))
			...
			.def("getTimeViewByName", (TimeConstView(DataPoints::*)(const std::string&) const) &DataPoints::getTimeViewByName, py::arg("name"))
			.def("getTimeViewByName", (TimeView(DataPoints::*)(const std::string&)) &DataPoints::getTimeViewByName, py::arg("name"))
			.def("getTimeRowViewByName", (TimeConstView(DataPoints::*)(const std::string&, const unsigned) const) &DataPoints::getTimeRowViewByName, py::arg("name"), py::arg("row"))
