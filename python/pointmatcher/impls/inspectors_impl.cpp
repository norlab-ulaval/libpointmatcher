...
namespace pointmatcher
{
	void pybindInspectorsImpl(py::module& p_module)
	{
		...
		py::class_<PerformanceInspector, std::shared_ptr<PerformanceInspector>, Inspector>(pyInspectorsImpl, "PerformanceInspector")
		    ...
		    .def("addStat", &PerformanceInspector::addStat)
		    .def("dumpStats", [](PerformanceInspector& self)
			{
		...
		py::class_<AbstractVTKInspector, std::shared_ptr<AbstractVTKInspector>, PerformanceInspector>
			(pyInspectorsImpl, "AbstractVTKInspector")
		...
		py::class_<VTKFileInspector, std::shared_ptr<VTKFileInspector>, AbstractVTKInspector>
			(pyInspectorsImpl, "VTKFileInspector")
			...
			.def("init", &VTKFileInspector::init)
			.def("finish", &VTKFileInspector::finish);
	}
}
