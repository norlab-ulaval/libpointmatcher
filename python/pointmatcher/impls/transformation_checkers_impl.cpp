...
namespace pointmatcher
{
	void pybindTransformationCheckersImpl(py::module& p_module)
	{
		...
		py::class_<TransformationCheckersImpl, std::shared_ptr<TransformationCheckersImpl>>
			pyTransformationCheckersImpl(p_module, "TransformationCheckersImpl");

		using CounterTransformationChecker = TransformationCheckersImpl::CounterTransformationChecker;
		py::class_<CounterTransformationChecker, std::shared_ptr<CounterTransformationChecker>, TransformationChecker>
		    (pyTransformationCheckersImpl, "CounterTransformationChecker")
		...
		py::class_<DifferentialTransformationChecker, std::shared_ptr<DifferentialTransformationChecker>, TransformationChecker>
		    (pyTransformationCheckersImpl, "DifferentialTransformationChecker")
		...
		py::class_<BoundTransformationChecker, std::shared_ptr<BoundTransformationChecker>, TransformationChecker>
		    (pyTransformationCheckersImpl, "BoundTransformationChecker")
