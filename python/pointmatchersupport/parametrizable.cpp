...
//			.def_readwrite("comp", &ParameterDoc::comp, "pointer to comparison function") // FIXME Get this error when compiling -> error: invalid conversion from ‘bool (*)(std::__cxx11::basic_string<char>, std::__cxx11::basic_string<char>)’ to ‘const void*’ [-fpermissive]
			...
			.def(py::init<const std::string&, const std::string&, const std::string&, const std::string&, const std::string&, Parametrizable::LexicalComparison>(),
					py::arg("name"), py::arg("doc"), py::arg("defaultValue"), py::arg("minValue"), py::arg("maxValue"), py::arg("comp"))
		...
		pyParametrizable
			...
			.def(py::init<>())
			.def(py::init<const std::string&, const ParametersDoc, Parameters&>(),
					py::arg("className"), py::arg("paramsDoc"), py::arg("params"))
