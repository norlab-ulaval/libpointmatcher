...
#   - execute `install_dependencies_ubuntu.bash` first
...
${SP}  -h, --help         Get help
${SP}  --compile-test     Compile the libpointmatcher unit-test in ${INSTALLED_LIBRARIES_PATH}/libpointmatcher/build
...
if [ ${BUILD_TESTS_FLAG} == 'TRUE' ]; then
  cd "${INSTALLED_LIBRARIES_PATH}/libpointmatcher/build"
  utest/utest --path "${INSTALLED_LIBRARIES_PATH}/libpointmatcher/examples/data/"
fi
